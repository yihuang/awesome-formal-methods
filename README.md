...
| **[Fundamentals](docs/01-fundamentals/)** | Specifications · logics · **semantics (small-step, big-step, functional/relational)** · **temporal logic (safety, liveness, stuttering)** · **type theory** · **Curry–Howard** · **separation logic** · the five verification techniques · SAT/SMT · hard limits |
...
| **[Tools](docs/05-tools/)** | ~40 tools in nine families · how to choose · **model verifiers: TLA+ / Ivy / Veil** · **Lean 4** · **Mathlib** · **proof tactics** · **Iris** |
